...
Evidencia externa reciente respalda la prioridad del harness sobre el algoritmo: en la receta abierta de RL agentic de Mercor/SkyRL, las correcciones al entorno de ejecución solas ---sin tocar el modelo--- equivalieron a una época completa de entrenamiento (+6 puntos), y los datos dominaron a las decisiones algorítmicas (+10-12 pts vs. +3.9 pts del mejor ajuste).\cite{mercor2026} Sus ablations, además, corrieron sobre la misma base MoE 35B-A3B de Tlamatini y superaron a modelos frontera cerrados tras el post-training.\label{sec:harness}
