...
\subsection{Por qué ahora: la ventana técnica}\label{sec:ventana}

Dos convergencias recientes hacen posible hoy lo que hace dos años no lo era.\vspace{0.3em}

\textbf{Los modelos locales están cerrando la brecha con la frontera.} El mejor modelo abierto de 27B parámetros ---Apache 2.0, ejecutable en hardware accesible--- obtiene 61.7 en SWE-bench Pro, a 5.2 puntos del mejor modelo frontera cerrado del mundo; en la generación anterior la brecha era de decenas de puntos, y el propio 27B ha multiplicado por 2.6 su puntaje en 17 meses (23.3 en marzo de 2025).\cite{qwen38_2026,swebench_pro} La implicación para IA jurídica es directa: la capacidad de razonamiento necesaria para derecho mexicano ya cabe en un modelo que un despacho puede ejecutar on-premise --- la soberanía dejó de exigir sacrificar calidad.\vspace{0.3em}

\textbf{El especialista vence al generalista en su terreno.} La evidencia transversal de modelos de dominio (médicos, jurídicos, financieros) muestra que el CPT de dominio con harness adecuado no iguala a modelos frontera en tareas del dominio: los supera. Lo replicamos en nuestro contexto: sometimos al mismo corpus y al mismo harness de recuperación a un gigante generalista de nube y a un modelo jurídico especialista de fundación. El especialista respondió el 33\% de la batería ciudadana contra el 7\% del generalista ---4 veces más---, con mejor anclaje de citas. La conclusión estratégica define el producto: no competimos contra la frontera general; competimos donde la frontera no puede ir ---derecho mexicano, anclado en fuentes primarias, desplegable dentro del despacho---.
