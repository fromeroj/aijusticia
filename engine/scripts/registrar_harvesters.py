...
REGISTRO = [
    ...
    ("LexMX", "harvest_lexmx.sh",
     "317 leyes federales vigentes en Markdown limpio con frontmatter (sigla, ultima_reforma ISO, fuente PDF). Repo con GitHub Actions de actualización DIARIA desde diputados/DOF; git history = changelog de reformas por ley. Basado en ingteranalvarez/lex-mx. Ventaja sobre nuestro scraper de LeyesBiblio: estructura semántica (artículos marcados) y diferencial gratis.",
     "git-sync", "https://github.com/ingteranalvarez/lex-mx", "server-tmux",
     "git pull; comparar state.json (ultima_reforma por sigla) contra watermark; ingerir solo leyes con fecha mayor",
     "diaria", False, lambda: {"leyes": 317, "tokens": 12713425}),
